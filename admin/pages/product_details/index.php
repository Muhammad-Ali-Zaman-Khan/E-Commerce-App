...
$query = "SELECT product_details.* , products.name as p_name from product_details join products on product_details.prod_id = products.id";
...
<div class="card basic-data-table">
  <div class="card-header">
    <h5 class="card-title mb-0">All Products Details</h5>
  </div>
  <div class="card-body ">
